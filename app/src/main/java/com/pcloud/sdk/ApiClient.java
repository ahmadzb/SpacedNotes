...
public interface ApiClient {
     ...
     * @return {@link Call}
     */
    Call<RemoteFolder> listFolder(String folderPath);
     ...
     * @return {@link Call} resulting in a {@link RemoteFolder} instance holding the metadata for the requested fodler id.
     */
    Call<RemoteFolder> listFolder(String folderPath, boolean recursively);
     ...
     * @throws IllegalArgumentException on a null {@code folderName} argument.
     */
    Call<RemoteFolder> createFolder(String folderPath);
     ...
     * @see UploadOptions
     */
    Call<RemoteFile> createFile(String folderPath, String filename, DataSource data);
     ...
     * @see UploadOptions
     */
    Call<RemoteFile> createFile(String folderPath, String filename, DataSource data, UploadOptions uploadOptions);
     ...
     * @see UploadOptions
     */
    Call<RemoteFile> createFile(String folderPath, String filename, DataSource data, Date modifiedDate, ProgressListener listener);
     ...
     * @see UploadOptions
     */
    Call<RemoteFile> createFile(String folderPath, String filename, DataSource data, Date modifiedDate, ProgressListener listener, UploadOptions uploadOptions);
     ...
     * <li>The provided {@link ConnectionPool} will have all connections evicted.</li>
     * <li>The {@link Dispatcher} will have it's Executor shutdown.</li>
     * <li>If provided, the {@link Cache} instance will closed.</li>
     * </ul>
     */
    void shutdown();
